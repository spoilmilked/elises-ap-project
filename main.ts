...
scene.onHitWall(SpriteKind.Player, function (sprite, location) {
    if (tiles.tileAtLocationEquals(location, assets.tile`baracade1`) || (tiles.tileAtLocationEquals(location, assets.tile`baracade0`) || (tiles.tileAtLocationEquals(location, assets.tile`baracade`) || tiles.tileAtLocationEquals(location, assets.tile`myTile2`)))) {
